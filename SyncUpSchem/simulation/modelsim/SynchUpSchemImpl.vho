...
ARCHITECTURE structure OF SynchUpSchemImpl IS
...
SIGNAL \syncUpSchem|SYNTHESIZED_WIRE_11~0_combout\ : std_logic;
SIGNAL \syncUpSchem|SYNTHESIZED_WIRE_11~feeder_combout\ : std_logic;
SIGNAL \externalRst~input_o\ : std_logic;
SIGNAL \syncUpSchem|SYNTHESIZED_WIRE_11~q\ : std_logic;
SIGNAL \syncUpSchem|SYNTHESIZED_WIRE_11~DUPLICATE_q\ : std_logic;
SIGNAL \syncUpSchem|SYNTHESIZED_WIRE_16~0_combout\ : std_logic;
SIGNAL \syncUpSchem|SYNTHESIZED_WIRE_16~feeder_combout\ : std_logic;
SIGNAL \syncUpSchem|SYNTHESIZED_WIRE_16~q\ : std_logic;
SIGNAL \syncUpSchem|SYNTHESIZED_WIRE_14~q\ : std_logic;
SIGNAL \syncUpSchem|SYNTHESIZED_WIRE_14~0_combout\ : std_logic;
SIGNAL \syncUpSchem|SYNTHESIZED_WIRE_14~feeder_combout\ : std_logic;
SIGNAL \syncUpSchem|SYNTHESIZED_WIRE_14~DUPLICATE_q\ : std_logic;
SIGNAL \syncUpSchem|DFF_inst13~q\ : std_logic;
SIGNAL \syncUpSchem|DFF_inst13~0_combout\ : std_logic;
SIGNAL \syncUpSchem|DFF_inst13~feeder_combout\ : std_logic;
SIGNAL \syncUpSchem|DFF_inst13~DUPLICATE_q\ : std_logic;
SIGNAL tBase : std_logic_vector(30 DOWNTO 0);
SIGNAL \syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_11~DUPLICATE_q\ : std_logic;
SIGNAL \syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_11~0_combout\ : std_logic;
SIGNAL ALT_INV_tBase : std_logic_vector(24 DOWNTO 0);
SIGNAL \syncUpSchem|ALT_INV_DFF_inst13~0_combout\ : std_logic;
SIGNAL \syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_14~0_combout\ : std_logic;
SIGNAL \syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_16~0_combout\ : std_logic;
SIGNAL \syncUpSchem|ALT_INV_DFF_inst13~q\ : std_logic;
SIGNAL \syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_14~q\ : std_logic;
SIGNAL \syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_16~q\ : std_logic;
SIGNAL \syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_11~q\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_11~DUPLICATE_q\ <= NOT \syncUpSchem|SYNTHESIZED_WIRE_11~DUPLICATE_q\;
\syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_11~0_combout\ <= NOT \syncUpSchem|SYNTHESIZED_WIRE_11~0_combout\;
...
\syncUpSchem|ALT_INV_DFF_inst13~0_combout\ <= NOT \syncUpSchem|DFF_inst13~0_combout\;
\syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_14~0_combout\ <= NOT \syncUpSchem|SYNTHESIZED_WIRE_14~0_combout\;
\syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_16~0_combout\ <= NOT \syncUpSchem|SYNTHESIZED_WIRE_16~0_combout\;
ALT_INV_tBase(24) <= NOT tBase(24);
\syncUpSchem|ALT_INV_DFF_inst13~q\ <= NOT \syncUpSchem|DFF_inst13~q\;
\syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_14~q\ <= NOT \syncUpSchem|SYNTHESIZED_WIRE_14~q\;
\syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_16~q\ <= NOT \syncUpSchem|SYNTHESIZED_WIRE_16~q\;
\syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_11~q\ <= NOT \syncUpSchem|SYNTHESIZED_WIRE_11~q\;
...
-- pragma translate_on
PORT MAP (
	i => \syncUpSchem|SYNTHESIZED_WIRE_11~q\,
	devoe => ww_devoe,
	o => ww_outBus(0));
...
-- pragma translate_on
PORT MAP (
	i => \syncUpSchem|SYNTHESIZED_WIRE_16~q\,
	devoe => ww_devoe,
	o => ww_outBus(1));
...
-- pragma translate_on
PORT MAP (
	i => \syncUpSchem|SYNTHESIZED_WIRE_14~DUPLICATE_q\,
	devoe => ww_devoe,
	o => ww_outBus(2));
...
-- pragma translate_on
PORT MAP (
	i => \syncUpSchem|DFF_inst13~DUPLICATE_q\,
	devoe => ww_devoe,
	o => ww_outBus(3));
...
\syncUpSchem|SYNTHESIZED_WIRE_11~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \syncUpSchem|SYNTHESIZED_WIRE_11~0_combout\ = ( !\syncUpSchem|SYNTHESIZED_WIRE_11~q\ )
...
-- pragma translate_on
PORT MAP (
	dataf => \syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_11~q\,
	combout => \syncUpSchem|SYNTHESIZED_WIRE_11~0_combout\);

-- Location: LABCELL_X30_Y2_N30
\syncUpSchem|SYNTHESIZED_WIRE_11~feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \syncUpSchem|SYNTHESIZED_WIRE_11~feeder_combout\ = ( \syncUpSchem|SYNTHESIZED_WIRE_11~0_combout\ )
...
-- pragma translate_on
PORT MAP (
	dataf => \syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_11~0_combout\,
	combout => \syncUpSchem|SYNTHESIZED_WIRE_11~feeder_combout\);
...
\syncUpSchem|SYNTHESIZED_WIRE_11\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => tBase(24),
	d => \syncUpSchem|SYNTHESIZED_WIRE_11~feeder_combout\,
	clrn => \externalRst~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \syncUpSchem|SYNTHESIZED_WIRE_11~q\);

-- Location: FF_X30_Y2_N31
\syncUpSchem|SYNTHESIZED_WIRE_11~DUPLICATE\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \syncUpSchem|SYNTHESIZED_WIRE_11~DUPLICATE_q\);

-- Location: LABCELL_X30_Y2_N27
\syncUpSchem|SYNTHESIZED_WIRE_16~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \syncUpSchem|SYNTHESIZED_WIRE_16~0_combout\ = ( !\syncUpSchem|SYNTHESIZED_WIRE_16~q\ & ( \syncUpSchem|SYNTHESIZED_WIRE_11~DUPLICATE_q\ ) ) # ( \syncUpSchem|SYNTHESIZED_WIRE_16~q\ & ( !\syncUpSchem|SYNTHESIZED_WIRE_11~DUPLICATE_q\ ) )
...
-- pragma translate_on
PORT MAP (
	datae => \syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_16~q\,
	dataf => \syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_11~DUPLICATE_q\,
	combout => \syncUpSchem|SYNTHESIZED_WIRE_16~0_combout\);

-- Location: LABCELL_X30_Y2_N21
\syncUpSchem|SYNTHESIZED_WIRE_16~feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \syncUpSchem|SYNTHESIZED_WIRE_16~feeder_combout\ = ( \syncUpSchem|SYNTHESIZED_WIRE_16~0_combout\ )
...
-- pragma translate_on
PORT MAP (
	dataf => \syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_16~0_combout\,
	combout => \syncUpSchem|SYNTHESIZED_WIRE_16~feeder_combout\);

-- Location: FF_X30_Y2_N23
\syncUpSchem|SYNTHESIZED_WIRE_16\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => tBase(24),
	d => \syncUpSchem|SYNTHESIZED_WIRE_16~feeder_combout\,
	clrn => \externalRst~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \syncUpSchem|SYNTHESIZED_WIRE_16~q\);

-- Location: FF_X30_Y2_N47
\syncUpSchem|SYNTHESIZED_WIRE_14\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => tBase(24),
	d => \syncUpSchem|SYNTHESIZED_WIRE_14~feeder_combout\,
	clrn => \externalRst~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \syncUpSchem|SYNTHESIZED_WIRE_14~q\);

-- Location: LABCELL_X30_Y2_N54
\syncUpSchem|SYNTHESIZED_WIRE_14~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \syncUpSchem|SYNTHESIZED_WIRE_14~0_combout\ = ( \syncUpSchem|SYNTHESIZED_WIRE_16~q\ & ( \syncUpSchem|SYNTHESIZED_WIRE_11~DUPLICATE_q\ & ( !\syncUpSchem|SYNTHESIZED_WIRE_14~q\ ) ) ) # ( !\syncUpSchem|SYNTHESIZED_WIRE_16~q\ & ( 
-- \syncUpSchem|SYNTHESIZED_WIRE_11~DUPLICATE_q\ & ( \syncUpSchem|SYNTHESIZED_WIRE_14~q\ ) ) ) # ( \syncUpSchem|SYNTHESIZED_WIRE_16~q\ & ( !\syncUpSchem|SYNTHESIZED_WIRE_11~DUPLICATE_q\ & ( \syncUpSchem|SYNTHESIZED_WIRE_14~q\ ) ) ) # ( 
-- !\syncUpSchem|SYNTHESIZED_WIRE_16~q\ & ( !\syncUpSchem|SYNTHESIZED_WIRE_11~DUPLICATE_q\ & ( \syncUpSchem|SYNTHESIZED_WIRE_14~q\ ) ) )
...
-- pragma translate_on
PORT MAP (
	datad => \syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_14~q\,
	datae => \syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_16~q\,
	dataf => \syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_11~DUPLICATE_q\,
	combout => \syncUpSchem|SYNTHESIZED_WIRE_14~0_combout\);

-- Location: LABCELL_X30_Y2_N45
\syncUpSchem|SYNTHESIZED_WIRE_14~feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \syncUpSchem|SYNTHESIZED_WIRE_14~feeder_combout\ = ( \syncUpSchem|SYNTHESIZED_WIRE_14~0_combout\ )
...
-- pragma translate_on
PORT MAP (
	dataf => \syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_14~0_combout\,
	combout => \syncUpSchem|SYNTHESIZED_WIRE_14~feeder_combout\);

-- Location: FF_X30_Y2_N46
\syncUpSchem|SYNTHESIZED_WIRE_14~DUPLICATE\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \syncUpSchem|SYNTHESIZED_WIRE_14~DUPLICATE_q\);

-- Location: FF_X30_Y2_N8
\syncUpSchem|DFF_inst13\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => tBase(24),
	d => \syncUpSchem|DFF_inst13~feeder_combout\,
	clrn => \externalRst~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \syncUpSchem|DFF_inst13~q\);

-- Location: LABCELL_X30_Y2_N12
\syncUpSchem|DFF_inst13~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \syncUpSchem|DFF_inst13~0_combout\ = ( \syncUpSchem|SYNTHESIZED_WIRE_16~q\ & ( \syncUpSchem|SYNTHESIZED_WIRE_11~DUPLICATE_q\ & ( !\syncUpSchem|DFF_inst13~q\ $ (!\syncUpSchem|SYNTHESIZED_WIRE_14~q\) ) ) ) # ( !\syncUpSchem|SYNTHESIZED_WIRE_16~q\ & ( 
-- \syncUpSchem|SYNTHESIZED_WIRE_11~DUPLICATE_q\ & ( \syncUpSchem|DFF_inst13~q\ ) ) ) # ( \syncUpSchem|SYNTHESIZED_WIRE_16~q\ & ( !\syncUpSchem|SYNTHESIZED_WIRE_11~DUPLICATE_q\ & ( \syncUpSchem|DFF_inst13~q\ ) ) ) # ( !\syncUpSchem|SYNTHESIZED_WIRE_16~q\ & ( 
-- !\syncUpSchem|SYNTHESIZED_WIRE_11~DUPLICATE_q\ & ( \syncUpSchem|DFF_inst13~q\ ) ) )
...
-- pragma translate_on
PORT MAP (
	datab => \syncUpSchem|ALT_INV_DFF_inst13~q\,
	datad => \syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_14~q\,
	datae => \syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_16~q\,
	dataf => \syncUpSchem|ALT_INV_SYNTHESIZED_WIRE_11~DUPLICATE_q\,
	combout => \syncUpSchem|DFF_inst13~0_combout\);

-- Location: LABCELL_X30_Y2_N6
\syncUpSchem|DFF_inst13~feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \syncUpSchem|DFF_inst13~feeder_combout\ = ( \syncUpSchem|DFF_inst13~0_combout\ )
...
-- pragma translate_on
PORT MAP (
	dataf => \syncUpSchem|ALT_INV_DFF_inst13~0_combout\,
	combout => \syncUpSchem|DFF_inst13~feeder_combout\);

-- Location: FF_X30_Y2_N7
\syncUpSchem|DFF_inst13~DUPLICATE\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \syncUpSchem|DFF_inst13~DUPLICATE_q\);
