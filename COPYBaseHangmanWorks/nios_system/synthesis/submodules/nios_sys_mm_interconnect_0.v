...
module nios_sys_mm_interconnect_0 (
	...
	wire  [93:0] cmd_mux_007_src_data;                                                                  // cmd_mux_007:src_data -> char_received_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                                 // char_received_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire  [10:0] cmd_mux_007_src_channel;                                                               // cmd_mux_007:src_channel -> char_received_s1_agent:cp_channel
	...
	wire  [93:0] cmd_mux_008_src_data;                                                                  // cmd_mux_008:src_data -> char_sent_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                                 // char_sent_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire  [10:0] cmd_mux_008_src_channel;                                                               // cmd_mux_008:src_channel -> char_sent_s1_agent:cp_channel
	...
	wire  [93:0] cmd_mux_010_src_data;                                                                  // cmd_mux_010:src_data -> load_s1_agent:cp_data
	wire         cmd_mux_010_src_ready;                                                                 // load_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire  [10:0] cmd_mux_010_src_channel;                                                               // cmd_mux_010:src_channel -> load_s1_agent:cp_channel
	...
	wire  [93:0] char_received_s1_agent_rp_data;                                                        // char_received_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [93:0] char_sent_s1_agent_rp_data;                                                            // char_sent_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [93:0] load_s1_agent_rp_data;                                                                 // load_s1_agent:rp_data -> router_012:sink_data
